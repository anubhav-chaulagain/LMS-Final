...
def logIn():
    ...
    lm_frame.config(background='#ffe9cf')
    ...
    l_dyhaa = CTkLabel(lm_frame, text='Create a new account !', text_color='black', font=('Microsoft YaHei UI Light', 13))
    ...
    sign_up_btn = Button(lm_frame, text='Sign Up', foreground='#57a1f8', font=('Microsoft YaHei UI Light', 11, 'bold'), background='#ffe9cf', border=0, cursor='hand2', command=signIn)
...
def signIn():
    ...
    m_frame.config(background='#ffe9cf')
    ...
    dyhaa = CTkLabel(m_frame, text='Already have an account?', text_color='black', font=('Microsoft YaHei UI Light', 13))
